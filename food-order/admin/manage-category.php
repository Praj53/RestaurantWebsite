                ...
                ?>
                    <tr>
                        ...
                        <td class="content">
                            ...
                            if ($img_name != "") {
                            ?>
                                <img src="<?php echo SITEURL; ?>images/category/<?php echo $img_name; ?>" width="100px" height="50px">
                            <?php
                        ...
                        <td class="content"><?php echo $featured ?></td>
                        <td class="content"><?php echo $active ?></td>
                        <td >
