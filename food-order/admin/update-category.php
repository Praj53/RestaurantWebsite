...
<div class="main-content">
    ...
    <div class="wrapper">
        ...
        if (isset($_POST['submit'])) {
            ...
            $id = $_POST['id'];
            $title = $_POST['title'];
            $curreent_image = $_POST['current_image'];
            ...
            if (isset($_FILES['image']['name'])) {
                ...
                if ($image_name != "") {
                    ...
                    //rename the image
                    $image_name = "Food_category_" . rand(000, 999) . '.' . $ext; //Food_category_.456.jpg
                    ...
                    if ($current_image != "") {
                        ...
                        if ($remove == false) {
                            $_SESSION['failed-remove'] = "<div class='error'>Failed To Rempve Current Image</div>";
                            header('location:' . SITEURL . 'admin/manage-category.php');
                            die();
                        }
                    } 
